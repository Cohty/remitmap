/**
 * data.js — Editable data layer for the Global MNO & Remittance Globe
 * ────────────────────────────────────────────────────────────────────
 * HOW TO UPDATE ON GITHUB:
 *   1. Open this file in your GitHub repo
 *   2. Click the pencil (edit) icon
 *   3. Make your changes and click "Commit changes"
 *   4. Netlify/Vercel redeploys automatically in ~30 seconds
 *
 * DATA SOURCES:
 *   MNO data:     GSMA Intelligence, TeleGeography GlobalComms, operator earnings (Q1 2025)
 *   Provider data: World Bank RPW March 2025, Monito.com, provider websites
 *   Remittance volumes: World Bank KNOMAD (auto-fetched live — see index.html)
 *
...
window.CURRENCY = {
  ...
  'Yemen':'YER','Zambia':'ZMW','Colombia':'COP','Cameroon':'XAF','Ethiopia':'ETB'
};

// ── REMITTANCE PROVIDERS ──────────────────────────────────────────────────────
// fee_usd: flat fee for a $200 transfer (USD)
// fx_pct:  FX margin above mid-market rate (%)
// Estimated total cost = (fee_usd/200*100) + fx_pct
// 'default' used for countries without specific data
window.PROVIDERS = {
  'default': [
  ...
  'India': [
    { name:'Wise',             fee_usd:1.14, fx_pct:0.41, delivery:'Instant',    type:'digital', url:'https://wise.com/send-money',             color:'#00B9FF', note:'Best USD→INR rate, deposits to any Indian bank' },
  ...
  'Mexico': [
    { name:'Remitly',   fee_usd:0,    fx_pct:0.50, delivery:'3 min',   type:'digital', url:'https://remitly.com',         color:'#FF2B5E', note:'Best USD→MXN rate, cash pickup or bank' },
  ...
  'Philippines': [
    { name:'Remitly',     fee_usd:0,    fx_pct:0.50, delivery:'3 min',   type:'digital', url:'https://remitly.com',         color:'#FF2B5E', note:'Market-leading PHP rates, GCash/bank' },
  ...
  'Pakistan': [
    { name:'Wise',        fee_usd:1.14, fx_pct:0.41, delivery:'1–2 days', type:'digital', url:'https://wise.com',           color:'#00B9FF', note:'Best USD→PKR rate for bank transfer' },
    { name:'Remitly',     fee_usd:0,    fx_pct:1.50, delivery:'3–5 min',  type:'digital', url:'https://remitly.com',         color:'#FF2B5E', note:'Fast to Jazz Cash, Easypaisa, banks' },
    { name:'HBL Express', fee_usd:0,    fx_pct:2.00, delivery:'1–2 hrs',  type:'bank',    url:'https://hblexpress.com',      color:'#006837', note:'Competitive NRP rates, HBL bank network' }
  ],
  'Egypt': [
  ...
  'Ukraine': [
    { name:'Wise',        fee_usd:1.14, fx_pct:0.41, delivery:'Instant',  type:'digital', url:'https://wise.com',            color:'#00B9FF', note:'Best USD→UAH rate, bank transfer' },
    { name:'Remitly',     fee_usd:0,    fx_pct:1.50, delivery:'3–5 min',  type:'digital', url:'https://remitly.com',         color:'#FF2B5E', note:'PrivatBank, Monobank, Oschadbank' },
    { name:'Western Union', fee_usd:5, fx_pct:2.50, delivery:'Minutes',   type:'agent',   url:'https://westernunion.com',    color:'#FFD700', note:'Pickup at Ukrposhta & Oshchadbank' }
  ],
  'Nepal': [
  ...
  'El Salvador': [
    ...
    { name:'Xoom',        fee_usd:4.99, fx_pct:0,    delivery:'Minutes',  type:'digital', url:'https://xoom.com',            color:'#003087', note:'USD→USD (SV uses USD), bank or cash' },
  ...
  'Pakistan': [
    ...
    { name:'ACE Money Transfer', fee_usd:0, fx_pct:1.80, delivery:'Minutes', type:'digital', url:'https://acemoneytransfer.com', color:'#0057A8', note:'Competitive PKR rates, popular UK→PK' }
  ]
};

// ── MNO DATA ──────────────────────────────────────────────────────────────────
// Updated Q1 2025. Edit and commit to update live.
// outflow: fallback if World Bank API has no outflow data for this country
window.MNO_DATA = {
  ...
  'China':{ mno:'China Mobile', subs:'1.004 billion', share:'57%', outflow:'$18B', note:'China Mobile crossed 1 billion subscribers in Q2 2024 — the only carrier in history to do so. Inflows mainly from diaspora in US, Canada, Australia.' },
  'India':{ mno:'Jio (Reliance)', subs:'482 million', share:'38%', outflow:'$7.5B', note:'India is the world\'s #1 remittance recipient for 16 years. Jio leads with 482M; Airtel (395M) is a fast-growing rival with strong 5G rollout.' },
  ...
  'Russia':{ mno:'MTS (Mobile TeleSystems)', subs:'81 million', share:'30%', outflow:'$14B', note:'MTS leads the Big Three (MegaFon, Beeline) despite geopolitical disruption. Major sender to CIS nations.' },
  ...
  'Germany':{ mno:'Deutsche Telekom', subs:'47 million', share:'38%', outflow:'$24B', note:'Europe\'s largest remittance sender — primarily to Turkey, Poland, Romania. Deutsche Telekom leads domestically and globally via T-Mobile US.' },
  ...
  'Mexico':{ mno:'Telcel (América Móvil)', subs:'82 million', share:'62%', outflow:'$1.7B', note:'Mexico received $68B in remittances in 2024 — the world\'s 2nd largest recipient. Telcel\'s dominance (~62%) is unmatched in LatAm.' },
  ...
  'Bangladesh':{ mno:'Grameenphone (Telenor)', subs:'86 million', share:'44%', outflow:'$415M', note:'Received ~$22B in 2024. Policy incentives redirected hundi flows to formal banking. Grameenphone leads by wide margin.' },
  'Philippines':{ mno:'Smart Communications (PLDT)', subs:'73 million', share:'54%', outflow:'$620M', note:'Received ~$40B in 2024. OFWs send money from 100+ countries. Smart leads ahead of Globe.' },
  'Egypt':{ mno:'Vodafone Egypt', subs:'47 million', share:'37%', outflow:'$940M', note:'Record ~$28B in 2024 after the March 2024 FX reform closed the official-parallel rate gap. Vodafone and Orange compete closely.' },
  'Vietnam':{ mno:'Viettel', subs:'120 million', share:'50%', outflow:'$720M', note:'Received ~$16B in 2024. Viettel is state-owned, operates in 11 countries. Diaspora in US, Australia, South Korea drive inflows.' },
  ...
  'Ukraine':{ mno:'Kyivstar (Veon)', subs:'24 million', share:'43%', outflow:'$2.2B', note:'Received ~$20B in 2024 (~11% of GDP). Wartime displacement massively boosted inflows. Kyivstar leads despite damage.' },
  ...
  'Malaysia':{ mno:'Maxis', subs:'11 million', share:'24%', outflow:'$7.2B', note:'Malaysia is a significant sender to Bangladesh, Indonesia, Nepal. Celcom and Digi merged into CelcomDigi in 2023.' },
  'Thailand':{ mno:'AIS (Advanced Info Service)', subs:'44 million', share:'43%', outflow:'$3.9B', note:'AIS leads. Hosts millions of Cambodian and Myanmar migrants. Received ~$7.8B in 2024.' },
  'Saudi Arabia':{ mno:'STC (Saudi Telecom Co.)', subs:'43 million', share:'45%', outflow:'$38B', note:'World\'s 3rd largest remittance sender. Millions of South Asian and Arab migrant workers send money home monthly.' },
  'UAE':{ mno:'Etisalat (e&)', subs:'14 million', share:'52%', outflow:'$45B', note:'World\'s 2nd largest remittance sender. Expats make up ~88% of the population. Etisalat (now e&) leads.' },
  ...
  'El Salvador':{ mno:'Tigo El Salvador', subs:'3.9 million', share:'44%', outflow:'$205M', note:'Received $8.2B in 2024 (~24% of GDP). First country with Bitcoin as legal tender partly to ease remittance fees.' },
  ...
  'Cuba':{ mno:'ETECSA', subs:'5.8 million', share:'100%', outflow:'N/A', note:'ETECSA state monopoly. Remittances (~$3.5B) complicated by US sanctions but flows continue.' },
  ...
  'Myanmar':{ mno:'Telenor Myanmar', subs:'17 million', share:'37%', outflow:'$310M', note:'Political instability has driven mass migration; informal channels dominate. Telenor Myanmar leads.' },
  'Taiwan':{ mno:'Chunghwa Telecom', subs:'12 million', share:'35%', outflow:'$4.2B', note:'Chunghwa Telecom is Taiwan\'s state-backed incumbent. Outflows go mainly to Southeast Asia.' },
  ...
  'Libya':{ mno:'Libyana', subs:'8 million', share:'54%', outflow:'$2.9B', note:'Libya is a transit and destination for Sub-Saharan migrants; sends significant remittances southward.' },
  'Sudan':{ mno:'Zain Sudan', subs:'13 million', share:'40%', outflow:'$415M', note:'Conflict has severely disrupted remittance channels. Zain leads despite widespread infrastructure damage.' },
  ...
  'Hungary':{ mno:'Magyar Telekom', subs:'5.2 million', share:'46%', outflow:'$1.3B', note:'Magyar Telekom (Deutsche Telekom subsidiary) leads. Hungarians in Germany and UK send home.' },
  'Czech Republic':{ mno:'T-Mobile Czech Republic', subs:'6.6 million', share:'36%', outflow:'$1.6B', note:'T-Mobile leads. Slovak, Ukrainian, Vietnamese diaspora shape remittance patterns.' },
  ...
  'Australia':{ mno:'Telstra', subs:'21 million', share:'42%', outflow:'$5.5B', note:'Telstra leads. Significant sender to Philippines, India, China, and Pacific Islands.' },
  'Canada':{ mno:'Bell Canada', subs:'10.8 million', share:'27%', outflow:'$25B', note:'Major sender to India and Philippines from large South Asian and Filipino diaspora.' },
  'Spain':{ mno:'Movistar (Telefónica)', subs:'17.5 million', share:'27%', outflow:'$12.5B', note:'Large Latin American immigrant population drives outflows. Also receives from Spaniards abroad.' },
  ...
  'Norway':{ mno:'Telenor Norway', subs:'3.9 million', share:'44%', outflow:'$1.9B', note:'Telenor is Norway\'s largest. Sends to Somalia, Pakistan, Eritrea, Eastern Europe.' },
  'Denmark':{ mno:'TDC NET', subs:'2.6 million', share:'34%', outflow:'$1.3B', note:'TDC leads. Flows primarily to Pakistan, Turkey, Lebanon, Somalia from diaspora communities.' },
  'Finland':{ mno:'Elisa', subs:'2.9 million', share:'38%', outflow:'$720M', note:'Elisa leads Finland. Somali and Russian diaspora communities are the most active senders.' },
  ...
  'Austria':{ mno:'A1 Telekom Austria', subs:'5.9 million', share:'36%', outflow:'$2.1B', note:'A1 leads. Bosnian, Serbian, Turkish diaspora drive significant outflows.' },
  'Greece':{ mno:'Cosmote (OTE)', subs:'7.6 million', share:'42%', outflow:'$1.5B', note:'Cosmote leads. Greeks in Germany and US send substantial inflows; also sends to Albania.' },
  'Bulgaria':{ mno:'Mtel (M-Tel Bulgaria)', subs:'4.0 million', share:'38%', outflow:'$620M', note:'Mtel leads. Large diaspora in Germany, Spain, UK are primary senders.' },
  'Croatia':{ mno:'Hrvatski Telekom (HT)', subs:'2.3 million', share:'51%', outflow:'$415M', note:'HT (Deutsche Telekom subsidiary) leads Croatia. Diaspora in Germany and Austria send flows.' },
  'Slovakia':{ mno:'Orange Slovakia', subs:'2.9 million', share:'39%', outflow:'$515M', note:'Orange leads. Slovak workers in Germany, Austria, UK send regular remittances home.' },
  'Slovenia':{ mno:'Telekom Slovenije', subs:'1.1 million', share:'44%', outflow:'$205M', note:'Telekom Slovenije is the incumbent. High-income country with modest remittance flows.' },
  'Lithuania':{ mno:'Telia Lithuania', subs:'1.7 million', share:'40%', outflow:'$415M', note:'Telia leads. Large communities in UK, Germany, Norway send significant inflows.' },
  'Ireland':{ mno:'Three Ireland', subs:'2.2 million', share:'34%', outflow:'$1.3B', note:'Three Ireland leads. Sends flows to Poland, Philippines, India from immigrant communities.' },
  ...
  'Mongolia':{ mno:'MobiCom', subs:'1.7 million', share:'37%', outflow:'$155M', note:'MobiCom leads. Workers in South Korea and Germany send the largest remittance flows home.' },
  'Laos':{ mno:'Unitel', subs:'4.3 million', share:'48%', outflow:'$205M', note:'Unitel leads Laos. Lao workers in Thailand and South Korea are the primary inward remittance source.' },
  'North Korea':{ mno:'Koryolink', subs:'6 million', share:'N/A', outflow:'N/A', note:'Koryolink is the sole operator (joint venture with Orascom). All economic data is restricted.' },
  'Papua New Guinea':{ mno:'Digicel PNG', subs:'3.6 million', share:'55%', outflow:'$52M', note:'Digicel dominates PNG. Australia is the main source of inward remittances.' },
  'Malawi':{ mno:'Airtel Malawi', subs:'5.3 million', share:'46%', outflow:'$42M', note:'Airtel leads. Remittances from Malawians in South Africa are an important income source.' },
  'Sierra Leone':{ mno:'Africell', subs:'4.2 million', share:'51%', outflow:'$31M', note:'Africell dominates. Diaspora in UK and US send substantial flows ($240M+) relative to economy.' },
  'Liberia':{ mno:'Lonestar Cell MTN', subs:'2.4 million', share:'48%', outflow:'$26M', note:'Lonestar Cell MTN leads. Liberian diaspora in US is the primary remittance source (~$460M).' },
  'Guinea':{ mno:'Orange Guinée', subs:'6 million', share:'40%', outflow:'$83M', note:'Orange Guinée leads. Guinean diaspora in France and Senegal are the main remittance sources.' },
  'Mali':{ mno:'Orange Mali', subs:'9.1 million', share:'43%', outflow:'$155M', note:'Orange Mali leads. Remittances from Malians in France and Côte d\'Ivoire ($1.1B+) are significant.' },
  'Niger':{ mno:'Airtel Niger', subs:'5.5 million', share:'44%', outflow:'$63M', note:'Airtel leads Niger. Remittances mainly from workers in Nigeria, Côte d\'Ivoire, France (~$415M).' },
  'Togo':{ mno:'Togocom', subs:'4.6 million', share:'48%', outflow:'$83M', note:'Togocom leads Togo. Remittances (~$460M, ~7% of GDP) mainly from France and Germany.' },
  'Madagascar':{ mno:'Telma', subs:'5.3 million', share:'37%', outflow:'$63M', note:'Telma leads Madagascar. Malagasy diaspora in France and Réunion are the main senders.' },
  'Namibia':{ mno:'MTC Namibia', subs:'2.9 million', share:'66%', outflow:'$83M', note:'MTC dominates Namibia. South Africa is both main source and destination of Namibian remittances.' },
  'Lesotho':{ mno:'Vodacom Lesotho', subs:'1.5 million', share:'54%', outflow:'$42M', note:'Vodacom leads. Remittances ($505M, ~17% of GDP) from Basotho mineworkers in South Africa.' },
  'Gabon':{ mno:'Airtel Gabon', subs:'2.1 million', share:'48%', outflow:'$205M', note:'Airtel leads Gabon. As a relatively wealthy oil producer, Gabon sends more than it receives.' },
  'Republic of Congo':{ mno:'MTN Congo', subs:'4.1 million', share:'47%', outflow:'$165M', note:'MTN leads. Remittance flows are modest relative to the country\'s oil export revenues.' },
  'DR Congo':{ mno:'Vodacom Congo', subs:'14.5 million', share:'28%', outflow:'$205M', note:'Vodacom Congo leads fragmented market. Large diaspora in Belgium and France send flows ($750M).' },
  'Bhutan':{ mno:'TashiCell', subs:'0.7 million', share:'43%', outflow:'$22M', note:'TashiCell competes with B-Mobile. Most remittances come from workers in India and the Gulf.' },
  'Luxembourg':{ mno:'POST Luxembourg', subs:'0.5 million', share:'44%', outflow:'$1.3B', note:'POST Luxembourg leads. As a major financial hub, Luxembourg punches above its weight in outflows.' },
  'Cyprus':{ mno:'CYTA', subs:'0.7 million', share:'45%', outflow:'$415M', note:'CYTA is the state-owned incumbent. Receives from diaspora and sends from large foreign worker communities.' },
  'Falkland Islands':{ mno:'Sure South Atlantic', subs:'3500', share:'100%', outflow:'N/A', note:'Sure provides the only mobile service on the Falkland Islands. Not applicable for remittances.' },
  ...
  'Suriname':{ mno:'Telesur', subs:'0.6 million', share:'48%', outflow:'$52M', note:'Telesur leads Suriname. Surinamese diaspora in the Netherlands are the primary remittance link.' },
  'Uruguay':{ mno:'Antel', subs:'2.1 million', share:'46%', outflow:'$155M', note:'Antel is state-owned and leads. Uruguay has a relatively small remittance footprint.' },
  'Trinidad and Tobago':{ mno:'Digicel T&T', subs:'1.7 million', share:'60%', outflow:'$305M', note:'As a relatively wealthy Caribbean nation, T&T sends more remittances than it receives.' },
  'Panama':{ mno:'Cable & Wireless Panama', subs:'2.5 million', share:'36%', outflow:'$415M', note:'Panama serves as a regional remittance transit point; uses USD.' },
  'Costa Rica':{ mno:'Kolbi (ICE)', subs:'3.6 million', share:'39%', outflow:'$510M', note:'Kolbi (state-owned ICE) leads. Receives flows from the US and sends to Nicaragua.' }
};
