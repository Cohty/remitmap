...
window.CURRENCY = {
  ...
  'Yemen':'YER','Zambia':'ZMW','Falkland Islands':'FKP','Botswana':'BWP','Burundi':'BIF','Equatorial Guinea':'XAF','Eritrea':'ERN','Georgia':'GEL','Palestine':'ILS','Greenland':'DKK','Guyana':'GYD','Iceland':'ISK','Kosovo':'EUR','New Caledonia':'XPF','South Sudan':'SSP','Azerbaijan':'AZN','Armenia':'AMD','Solomon Islands':'SBD','Belarus':'BYN','Central African Republic':'XAF','Estonia':'EUR','Fiji':'FJD','Hong Kong':'HKD','Latvia':'EUR','Mauritania':'MRU','Moldova':'MDL','Montenegro':'EUR','Vanuatu':'VUV','Timor-Leste':'USD','Western Sahara':'MAD','Turkmenistan':'TMT','North Macedonia':'MKD','Bosnia and Herzegovina':'BAM','Chad':'XAF','Gambia':'GMD','Ivory Coast':'XOF','Liechtenstein':'CHF','Montserrat':'XCD','Oman':'OMR','Guinea-Bissau':'XOF','Anguilla':'XCD','Serbia':'RSD','Burkina Faso':'XOF','Samoa':'WST'
};
...
window.MNO_DATA = {
  ...
  // ── BATCH 3 — additional countries found missing ─────────────────────────
  'Azerbaijan':{ mno:'Azercell', subs:'5.1 million', share:'44%', outflow:'$1.9B', note:'Azercell leads Azerbaijan ahead of Bakcell and Nar. Azerbaijan receives ~$2.7B in remittances mainly from Russia and Turkey, and sends significant flows to neighbouring countries.' },
  'Armenia':{ mno:'Viva-MTS', subs:'2.0 million', share:'54%', outflow:'$415M', note:'Viva-MTS (Russian-Armenian joint venture) leads ahead of Ucom and Beeline. Remittances (~$2.1B, ~13% of GDP) flow mainly from Russia and the large Armenian diaspora in the US and France.' },
  'Belarus':{ mno:'A1 Belarus', subs:'4.8 million', share:'41%', outflow:'$820M', note:'A1 Belarus (formerly Velcom) leads ahead of MTS and life:). Russia is the dominant source of inward remittances. Western sanctions have constrained formal transfer channels since 2020.' },
  'Central African Republic':{ mno:'Orange CAR', subs:'1.2 million', share:'52%', outflow:'$15M', note:'Orange CAR leads the fragmented market. One of the world\'s poorest countries — formal remittance infrastructure is extremely limited; diaspora in France and Chad send ~$42M annually.' },
  'Estonia':{ mno:'Telia Estonia', subs:'0.9 million', share:'40%', outflow:'$415M', note:'Telia Estonia leads ahead of Elisa and Tele2. Estonia sends flows to Ukraine and beyond from its immigrant communities, and receives from Estonians working abroad in Finland and the UK.' },
  'Fiji':{ mno:'Vodafone Fiji', subs:'0.7 million', share:'55%', outflow:'$26M', note:'Vodafone Fiji dominates ahead of Digicel. Remittances (~$470M, ~9% of GDP) from Fijians in Australia, New Zealand, and the US are a key income source.' },
  'Hong Kong':{ mno:'HKT (PCCW)', subs:'3.6 million', share:'34%', outflow:'$3.8B', note:'HKT (PCCW Group) leads Hong Kong\'s highly competitive market. As a global financial hub, Hong Kong sends significant remittances to mainland China and Southeast Asia from its large Filipino and Indonesian domestic worker population.' },
  'Latvia':{ mno:'LMT', subs:'0.8 million', share:'36%', outflow:'$415M', note:'LMT leads Latvia ahead of Tele2 and Bite. Latvia receives substantial flows from Latvians working in the UK, Germany, and Ireland (~$1.0B, ~4% of GDP).' },
  'Mauritania':{ mno:'Mauritel', subs:'3.2 million', share:'42%', outflow:'$83M', note:'Mauritel (state-owned) leads ahead of Mattel and Chinguitel. Remittances (~$265M) from Mauritanian workers in France and Senegal are an important income source.' },
  'Moldova':{ mno:'Orange Moldova', subs:'1.9 million', share:'43%', outflow:'$620M', note:'Orange Moldova leads ahead of Moldcell. Moldova has one of Europe\'s highest remittance-to-GDP ratios (~$2.5B, ~17% of GDP), mainly from workers in Russia, Italy, and Germany.' },
  'Montenegro':{ mno:'Crnogorski Telekom', subs:'0.45 million', share:'42%', outflow:'$205M', note:'Crnogorski Telekom (Deutsche Telekom subsidiary) leads. Montenegro receives flows from its diaspora in Serbia, Germany, and Switzerland. It adopted the Euro without being an EU member.' },
  'North Macedonia':{ mno:'Makedonski Telekom', subs:'0.82 million', share:'44%', outflow:'$205M', note:'Makedonski Telekom (Deutsche Telekom) leads. Remittances (~$470M, ~9% of GDP) from Macedonians in Germany, Switzerland, Austria, and Italy are significant.' },
  'Solomon Islands':{ mno:'Our Telekom', subs:'0.35 million', share:'58%', outflow:'$15M', note:'Our Telekom leads the Solomon Islands. Remittances (~$70M) from Solomonese working in Australia and New Zealand under seasonal worker programmes are growing.' },
  'Timor-Leste':{ mno:'Timor Telecom', subs:'0.75 million', share:'48%', outflow:'$15M', note:'Timor Telecom leads ahead of Telemor. As one of Asia\'s youngest nations, Timor-Leste receives remittances from workers in Australia and South Korea (~$85M).' },
  'Turkmenistan':{ mno:'Altyn Asyr', subs:'3.5 million', share:'100%', outflow:'$205M', note:'Altyn Asyr (state-owned) is the sole operator. Turkmenistan\'s closed economy severely restricts formal remittance channels; unofficial flows from workers in Russia and Turkey dominate.' },
  'Vanuatu':{ mno:'Digicel Vanuatu', subs:'0.22 million', share:'58%', outflow:'$15M', note:'Digicel Vanuatu leads ahead of TVL. Remittances from Vanuatuans working in Australia and New Zealand under seasonal worker schemes have grown rapidly.' },
  'Western Sahara':{ mno:'Maroc Telecom (via Morocco)', subs:'N/A', share:'N/A', outflow:'N/A', note:'Western Sahara is administered by Morocco; Maroc Telecom operates in Moroccan-controlled areas. As a disputed territory with no internationally recognised government, remittance and mobile data are subsumed under Morocco\'s statistics.' },

  // ── BATCH 4 ─────────────────────────────────────────────────────────────
  'Bosnia and Herzegovina':{ mno:'BH Telecom', subs:'2.0 million', share:'48%', outflow:'$820M', note:'BH Telecom leads Bosnia and Herzegovina ahead of m:tel and HT Eronet. Remittances (~$2.5B, ~14% of GDP) from Bosniaks in Germany, Austria, Sweden and Switzerland are a vital income source.' },
  'Chad':{ mno:'Airtel Chad', subs:'4.5 million', share:'42%', outflow:'$52M', note:'Airtel Chad leads ahead of Moov Africa. One of Africa\'s poorest and most landlocked countries — diaspora in France and Sudan send modest flows (~$180M annually).' },
  'Gambia':{ mno:'Africell Gambia', subs:'2.8 million', share:'46%', outflow:'$15M', note:'Africell Gambia dominates ahead of QCell and Comium. Remittances (~$500M, ~27% of GDP) from Gambians in the UK, US, and Scandinavia are the country\'s largest foreign income source.' },
  'Ivory Coast':{ mno:'Orange Côte d\'Ivoire', subs:'12.5 million', share:'36%', outflow:'$415M', note:'Orange Côte d\'Ivoire leads ahead of MTN and Moov Africa. Ivory Coast is both a major remittance receiver (~$1.1B) from diaspora in France and a sender to Burkina Faso, Mali, and Guinea.' },
  'Liechtenstein':{ mno:'FL1 (Telecom Liechtenstein)', subs:'35,000', share:'~100%', outflow:'N/A', note:'FL1 (formerly Telecom FL) is the sole national operator in this tiny principality. As a global financial centre with ~38,000 residents, Liechtenstein\'s remittance flows are minimal and linked to Switzerland.' },
  'Montserrat':{ mno:'Cable & Wireless Montserrat', subs:'4,000', share:'~100%', outflow:'N/A', note:'Cable & Wireless serves this tiny British Overseas Territory of ~4,500 people. Most of the pre-1995 population emigrated after the Soufrière Hills volcanic eruptions; diaspora in the UK send vital flows.' },
  'Oman':{ mno:'Omantel', subs:'4.1 million', share:'41%', outflow:'$11B', note:'Omantel (state-owned) leads Oman ahead of Ooredoo Oman. Oman is a significant remittance sender — a large South Asian workforce of over 1.5 million workers sends roughly $11B home annually to India, Bangladesh, and Pakistan.' },
  'Guinea-Bissau':{ mno:'MTN Guinea-Bissau', subs:'1.8 million', share:'48%', outflow:'$15M', note:'MTN Guinea-Bissau leads ahead of Orange. One of West Africa\'s smallest economies — remittances (~$95M) from the diaspora in Portugal, France, and Senegal are relatively significant at ~8% of GDP.' },
  'Anguilla':{ mno:'Digicel Anguilla', subs:'18,000', share:'~100%', outflow:'N/A', note:'Digicel Anguilla serves this British Overseas Territory of ~18,000 people. As a high-income Caribbean territory linked to the UK, remittance flows are minimal.' },
  'Serbia':{ mno:'Telekom Srbija', subs:'5.2 million', share:'43%', outflow:'$1.3B', note:'Telekom Srbija leads ahead of Yettel (formerly Telenor) and A1 Serbia. Serbia receives ~$4.5B in remittances (12% of GDP) mainly from its large diaspora in Germany, Austria, and Switzerland.' },
  'Burkina Faso':{ mno:'Orange Burkina Faso', subs:'7.2 million', share:'41%', outflow:'$83M', note:'Orange Burkina Faso leads ahead of Telecel and Moov Africa. Remittances (~$415M) from Burkinabè workers in Ivory Coast, France, and Italy are important despite the country\'s ongoing security challenges.' },
  'Samoa':{ mno:'Digicel Samoa', subs:'0.18 million', share:'61%', outflow:'$15M', note:'Digicel Samoa leads ahead of Vodafone Samoa. Remittances (~$230M, ~23% of GDP) from Samoans in New Zealand, Australia, and the US are among the Pacific\'s highest remittance-to-GDP ratios.' },
